function createUnityInstance(t, n, d) {
      ...
      : m.symbolsUrl
        ? I('symbolsUrl')
            .then(function (e) {
              ...
              ;(m.symbols = JSON.parse(t)), P(T(r, m.symbols), o, a)
            })
            .catch(function (e) {
              P(r, o, a)
            })
  ...
  function D(e) {
    return (D.link = D.link || document.createElement('a')), (D.link.href = e), D.link.href
  }
  ;(m.SystemInfo = (function () {
    ...
    (m.UnityCache =
      ...
      (A.UnityCacheDatabase = h),
      (A.RequestMetaDataStore = f),
      (A.MaximumCacheSize = 1073741824),
      (A.prototype.loadRequest = function (e) {
        var t = this
      ...
      (A.prototype.loadRequestMetaData = function (e) {
        e = 'string' == typeof e ? e : e.url
        return this.execute(f.name, 'get', [e])
      }),
      (A.prototype.updateRequestMetaData = function (e) {
        return this.execute(f.name, 'put', [e])
      }),
      (A.prototype.storeRequest = function (e, t) {
        var n = this
      ...
      (A.prototype.upgradeDatabase = function (e) {
        var t,
          e = e.target.result
      ...
      (A.prototype.execute = function (a, i, s) {
        return this.isConnected.then(
          function () {
            return new Promise(
              function (t, n) {
      ...
      (A.prototype.getMetaDataEntries = function () {
        var r = this,
          o = 0,
          a = []
      ...
      (A.prototype.cleanUpCache = function () {
        var i = this
        return this.getMetaDataEntries().then(function (e) {
          ...
          for (a = 0; a < o.length && !(n < A.MaximumCacheSize); ++a) r.push(o[a]), (n -= o[a].size)
          return (function e() {
            var t
            return 0 === r.length
              ? Promise.resolve()
              ...
              : 304 === e.status
                ? ((d.revalidated = !0),
                  i
                    ...
                    .then(function () {
                      k("'" + d.metaData.url + "' successfully revalidated and served from the browser cache")
                    })
                    .catch(function (e) {
                      k(
                        "'" +
        ...
        return (
          ...
          d.enabled
            ? i
                      ...
                      'immutable' == d.control
                        ? ((d.revalidated = !0),
                          i.updateRequestMetaData(r).then(function () {
                            k("'" + d.metaData.url + "' served from the browser cache without revalidation")
                          }),
                ...
                .catch(function (e) {
                  return k("Failed to load '" + d.metaData.url + "' from browser cache due to the error: " + e), v(o, a)
                })
            : v(o, a)
        )
      }))
  ...
  function I(t) {
    ...
    return n(m[t], {
      ...
      .then(function (e) {
        var t, n, r, o, a, i
        return (
          x.gzip.hasUnityMarker(e.parsedBody) && (t = ['gzip', 'gzip']),
          (t = x.br.hasUnityMarker(e.parsedBody) ? ['brotli', 'br'] : t) &&
    ...
    var t = performance.now(),
      p =
        (new Promise(function (a, e) {
          ...
          ;(m.webAssemblyTimeStart = performance.now()), e(m), (m.codeDownloadTimeEnd = performance.now() - t)
        }),
        performance.now()),
      e = I('dataUrl')
