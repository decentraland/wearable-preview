 ...
 * any other content URL.
 */
export function blobToBase64Definition(itemWithBlobs: WearableWithBlobs | EmoteWithBlobs): string {
  ...
  previousObjectUrls = representations.flatMap((representation) => representation.contents.map((content) => content.url))
